      ...
      <div className="w-[100vw]">
        ...
        <div className="flex flex-col justify-center bg-white align-middle text-center text-home-blue">
          ...
          <div className="grid grid-cols-2 mt-16 mb-10 mr-6 ml-6 gap-8">
            <div className="flex flex-col align-middle pr-10" id="bpm">
            ...
            <div className="flex flex-col align-middle pr-10" id="nfdmp">
              <h1 className="text-[10vw] mt-auto mb-auto">Nonfat Dry Milk</h1>
            </div>
            <div className="flex flex- shrink flex-col align-middle pr-10" id="smp">
            ...
            <div className="flex flex-col align-middle pr-10" id="bb">
