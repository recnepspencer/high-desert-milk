export default function ContactUs() {
    return (
        <div>
            <div className="pt-[148px] lg:pl-[5vw] lg:pr-[5vw] max-w-screen-xl xl:ml-auto xl:mr-auto">
                <div className="relative text-home-blue">
                    ...
                    <div className="absolute top-0 w-full ">
                        ...
                        <form className="flex flex-col m-4 p-2 text-center rounded-lg items-center ml-auto mr-auto w-[275px] bg-slate-300">
